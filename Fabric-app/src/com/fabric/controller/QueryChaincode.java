...
public class QueryChaincode {
	...
	public static String Query(String args[]) {
		try {
			...
			Collection<ProposalResponse>  responsesQuery = channelClient.queryByChainCode("fabcar", "queryAllMsg", null);
...
//			
//			Collection<ProposalResponse>  responses1Query = channelClient.queryByChainCode("fabcar", "queryReceivedMsg", args1);
